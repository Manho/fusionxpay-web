# FusionXPay Documentation

Welcome to the FusionXPay documentation! Choose your path:

## 📘 User Guide

**For merchants and integrators** - Learn how to integrate FusionXPay into your application.
...
**For contributors and operators** - Technical documentation for running and contributing to FusionXPay.
