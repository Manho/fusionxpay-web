              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-9 h-9 rounded-full glass flex items-center justify-center text-gray-500 hover:text-[#2d1ef5] hover:border-[#2d1ef5]/30 transition-all duration-300"
                  >
