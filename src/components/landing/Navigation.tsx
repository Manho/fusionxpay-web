      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-6 xl:gap-8">
          {navLinks.map((link) => (
            <a
              ...
              className="text-zinc-400 text-sm font-medium hover:text-white transition-colors relative group whitespace-nowrap"
            >
              {link.label}
        ...
        <div className="hidden md:flex items-center gap-2 lg:gap-3 shrink-0">
          <a
            ...
            className="text-muted-foreground hover:text-foreground transition-colors hidden lg:flex"
            aria-label="GitHub"
          >
          ...
          <Button
            variant="ghost"
            size="sm"
            className="text-zinc-500 hover:text-zinc-300 font-medium tracking-wide transition-colors whitespace-nowrap"
            asChild
          >
          ...
          <Button
            size="sm"
            className="bg-white text-black hover:bg-zinc-200 transition-all duration-300 shadow-[0_0_15px_rgba(255,255,255,0.1)] hover:shadow-[0_0_20px_rgba(255,255,255,0.2)] font-semibold tracking-wide border-0 whitespace-nowrap"
            asChild
          >
